    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoUser", x => new { x.UserId, x.VideoId });
                    table.ForeignKey(
                        name: "FK_VideoUser_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VideoUser_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VideoUser_Videos_VideoId",
                        column: x => x.VideoId,
                        principalTable: "Videos",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VideoUser_Videos_VideoId1",
                        column: x => x.VideoId1,
                        principalTable: "Videos",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoUser_UserId1",
                table: "VideoUser",
                column: "UserId1");

            migrationBuilder.CreateIndex(
                name: "IX_VideoUser_VideoId",
                table: "VideoUser",
                column: "VideoId");

            migrationBuilder.CreateIndex(
                name: "IX_VideoUser_VideoId1",
                table: "VideoUser",
                column: "VideoId1");
        }
